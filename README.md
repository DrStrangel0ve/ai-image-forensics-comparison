...
A blur-plus-resize tiled-DINO stress comparison is checked into [reports/tiled_dinov2_transform_stress_comparison_2026_06_14.md](reports/tiled_dinov2_transform_stress_comparison_2026_06_14.md). Blur1 improves from 0.7105 / 0.7872 to 0.7251 / 0.8032 accuracy/AUC with fused DINOv2 `tile_max`, and resize-half improves from 0.7164 / 0.7816 to 0.7310 / 0.7956. The repeated pattern is useful: standalone tiled DINO is not strong under these transforms, but as a fused branch it gives a small robust decision/ranking lift with mixed calibration.
