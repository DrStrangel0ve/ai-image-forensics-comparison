...
A broader target-transform check is now checked in for [blur1](reports/ms_cocoai_to_ishu_tuned_fusion_blur1_robustness_2026_06_13.md), [resize_half](reports/ms_cocoai_to_ishu_tuned_fusion_resize_half_robustness_2026_06_13.md), and [crop85](reports/ms_cocoai_to_ishu_tuned_fusion_crop85_robustness_2026_06_13.md). The same source-selected `cap_0p4` policy is weakest under blur and half-resolution resize at 0.7105 / 0.7872 and 0.7164 / 0.7816 accuracy/AUC, while crop85 is closer to clean at 0.7251 / 0.8227. This turns robustness from a single positive JPEG check into a clearer stress-test story.
