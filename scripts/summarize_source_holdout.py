...
from forensic_compare.metrics import best_threshold, binary_metrics
...
def main() -> None:
    ...
    summary = (
        ...
        .agg(
            mean_default_accuracy=("default_accuracy", "mean"),
            mean_source_threshold_accuracy=("source_threshold_accuracy", "mean"),
            mean_oracle_accuracy=("oracle_accuracy", "mean"),
            mean_roc_auc=("roc_auc", "mean"),
        )
        .sort_values("mean_source_threshold_accuracy", ascending=False)
    )
