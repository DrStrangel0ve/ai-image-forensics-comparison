...
TASKS = [
    ...
    },
    {
        ...
        "status": "bounded_transfer_probe_complete_pretrained_branch_next",
        "why": "AEROBLADE/FIRE-style reconstruction signals are a major SOTA direction and are not yet a full branch here.",
        "primary_gap": "reconstruction_lite now has bounded same-domain and Ishu -> MS transfer probes, but no pretrained autoencoder or diffusion-reconstruction detector branch is implemented yet.",
        "commands": "Use `python scripts/summarize_reconstruction_lite_transfer_probe.py` for the bounded transfer diagnostic, add reconstruction_lite scores to source-aware score fusion, then add cached autoencoder/diffusion-reconstruction residual features.",
