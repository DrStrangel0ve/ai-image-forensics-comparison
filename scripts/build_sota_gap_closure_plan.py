...
TASKS = [
    ...
    },
    {
        ...
        "status": "resize_stress_probe_complete",
        ...
        "primary_gap": "CLIP, DINOv2, and ConvNeXt reverse-transfer tiling are benchmarked and folded into a fixed reverse SCP-Fusion diagnostic; DINOv2 tiled fusion has one resize-half stress probe, but JPEG/blur/screenshot checks and official high-resolution benchmark runs are still pending.",
        ...
        "exit_criterion": "Show whether the fused tiled-foundation gain over 0.8472 AUC survives source-heldout selection and repeated resize/blur/JPEG/screenshot stress losses.",
