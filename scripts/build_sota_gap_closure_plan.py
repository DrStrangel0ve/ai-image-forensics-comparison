...
TASKS = [
    ...
    },
    {
        ...
        "status": "reverse_foundation_passes_complete",
        ...
        "primary_gap": "CLIP, DINOv2, and ConvNeXt reverse-transfer tiling are now benchmarked; source-heldout fused use is still pending.",
        "commands": "Run `python scripts/build_tiled_foundation_comparison.py`, then fold the best tiled foundation modes into the reverse/source-heldout SCP-Fusion stack.",
...
def build_closure_plan(sota_gap_path: Path) -> tuple[str, pd.DataFrame]:
    ...
    lines = [
        ...
        "2. Use the completed CLIP/DINOv2/ConvNeXt tiled reverse-transfer comparison to choose foundation score modes for fused source-heldout selection.",
