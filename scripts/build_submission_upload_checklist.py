...
UPLOAD_ITEMS = [
    ...
    },
    {
        ...
        "venue": "DFRWS-USA 2026 poster/demo",
        "deadline": "2026-07-07",
        "item": "candidate poster PDF export",
        "status": "ready_asset",
        "paths": "reports/assets/dfrws_poster_draft_v2_2026_06_13_candidate_export.pdf; reports/dfrws_poster_candidate_export_2026_06_15.md",
        "action": "Use this 16:9 PDF as a fast upload fallback if the portal accepts PDF poster or slide uploads; still check exact portal requirements before final submission.",
    },
    {
        "venue_key": "DFRWS",
        "venue": "DFRWS-USA 2026 poster/demo",
    ...
    },
    {
        ...
        "status": "ready_asset",
        "paths": "reports/assets/latex_tables/method_family_comparison.tex; reports/assets/latex_tables/same_domain_anchor.tex; reports/assets/latex_tables/transfer_frontier.tex; reports/assets/latex_tables/reverse_operating_points.tex; reports/assets/latex_tables/calibration_operating_modes.tex; reports/assets/latex_tables/paired_seed_support.tex; reports/assets/latex_tables/robustness_stress.tex; reports/assets/latex_tables/source_holdout_stress.tex; reports/assets/latex_tables/reconstruction_ablation.tex; references.bib",
        "action": "Pull compact tables and references into the paper template, including objective-specific operating modes and paired-seed support; verify final citation metadata before submission.",
    },
    {
        "venue_key": "WIFS",
        "venue": "IEEE WIFS 2026 paper",
...
def build_upload_checklist(
    repo_root: Path,
    word_counts_path: Path | None = None,
    ...
    return _write_markdown(checklist, run_date), checklist
...
def _write_markdown(checklist: pd.DataFrame, run_date: date) -> str:
...
def main() -> None:
    args = parse_args()
    text, checklist = build_upload_checklist(
        Path(args.repo_root),
        Path(args.word_counts),
