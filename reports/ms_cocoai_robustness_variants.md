...
This run evaluates whether the strongest conventional baseline, `combined_v3`, the saved ResNet-18 baseline, and the physics-guided ResNet-18 + `combined_v3` fusion model survive common image-sharing transformations. The test uses the same 1,000-image source-balanced Defactify/MS COCOAI validation slice from `reports/ms_cocoai_source_balanced_validation.md`.
...
| blur1 | physics_guided_resnet18_combined_v3 | 0.7610 | -0.0190 | 0.8733 | -0.0057 |
| blur1 | resnet18 | 0.7990 | -0.0170 | 0.8879 | -0.0089 |
| crop85 | combined_v3 | 0.7140 | -0.0180 | 0.7977 | -0.0049 |
| crop85 | physics_guided_resnet18_combined_v3 | 0.7760 | -0.0040 | 0.8768 | -0.0021 |
| crop85 | resnet18 | 0.8100 | -0.0060 | 0.8938 | -0.0029 |
| jpeg70 | combined_v3 | 0.7340 | +0.0020 | 0.7994 | -0.0033 |
| jpeg70 | physics_guided_resnet18_combined_v3 | 0.7820 | +0.0020 | 0.8795 | +0.0005 |
| jpeg70 | resnet18 | 0.8170 | +0.0010 | 0.8974 | +0.0007 |
| resize_half | combined_v3 | 0.6940 | -0.0380 | 0.7920 | -0.0107 |
| resize_half | physics_guided_resnet18_combined_v3 | 0.7680 | -0.0120 | 0.8781 | -0.0008 |
...
Gaussian blur is the main weakness for the conventional baseline. `combined_v3` drops 9.7 accuracy points under `blur1`, while ResNet-18 drops 1.7 points and the fusion model drops 1.9 points. Half-resolution roundtrip also hurts `combined_v3` more than the neural models: fusion drops 1.2 points and ResNet-18 drops 0.5 points. Center crop/resize is comparatively mild for all three methods.

The fusion model is clearly more robust than standalone `combined_v3` on these transforms, but it does not overtake vanilla ResNet-18 on MS COCOAI. Its clean source-balanced score is 0.7800 accuracy / 0.8790 AUC, compared with ResNet-18 at 0.8160 / 0.8967 and `combined_v3` at 0.7320 / 0.8027. This matches the same-domain benchmark: MS COCOAI favors the pure neural baseline, while Ishu favors the physics-guided fusion.
...
Evaluate each variant with the saved `combined_v3`, ResNet-18, and physics-guided fusion models:
...
python scripts/evaluate_physics_guided_net.py `
  ...
  --target-dir data/raw/ms_cocoai_2026_source_balanced_robustness_variants/jpeg70 `
  --output-dir runs/ms_cocoai_2026_robustness_eval/jpeg70/physics_guided_resnet18_combined_v3 `
  --image-size 128 `
...
Run the clean source-balanced fusion baseline, repeat the three evaluation commands for `blur1`, `resize_half`, and `crop85`, then summarize:
...
python scripts/summarize_robustness_eval.py `
  --out-dir runs/ms_cocoai_2026_robustness_eval/summary_with_fusion `
  ...
  --baseline physics_guided_resnet18_combined_v3=runs/ms_cocoai_2026_source_balanced_eval/physics_guided_resnet18_combined_v3/metrics.json `
  ...
  --metrics jpeg70:physics_guided_resnet18_combined_v3=runs/ms_cocoai_2026_robustness_eval/jpeg70/physics_guided_resnet18_combined_v3/metrics.json `
  ...
  --metrics blur1:physics_guided_resnet18_combined_v3=runs/ms_cocoai_2026_robustness_eval/blur1/physics_guided_resnet18_combined_v3/metrics.json `
  ...
  --metrics resize_half:physics_guided_resnet18_combined_v3=runs/ms_cocoai_2026_robustness_eval/resize_half/physics_guided_resnet18_combined_v3/metrics.json `
  ...
  --metrics crop85:physics_guided_resnet18_combined_v3=runs/ms_cocoai_2026_robustness_eval/crop85/physics_guided_resnet18_combined_v3/metrics.json
```
