...
- The tuned-fusion frontier now has four target-transform checks. The same source-selected cap_0p4 policy is stable under JPEG70 at 0.7661 accuracy / 0.8485 AUC, weaker under blur1 at 0.7105 / 0.7872 and resize_half at 0.7164 / 0.7816, and partly recovers under crop85 at 0.7251 / 0.8227. This is now a real robustness stress result rather than a single JPEG-only check.
