...
| quality-control | reports/competition_submission_dry_run_2026_06_15.md | Challenge-style dry-run proving that checked-in per-image scores can be packaged, stripped of labels, and linted before upload. |
| quality-control | reports/assets/competition_dry_run/predictions.csv | Small derived prediction fixture used to exercise competition packaging; not an upload file. |
| quality-control | reports/assets/competition_dry_run/expected_ids.csv | Expected image-id list used by the competition dry-run lint check. |
| quality-control | reports/assets/competition_dry_run/submission.csv | Upload-shaped competition dry-run submission with scores, labels, confidence, and triage but no ground-truth labels. |
| quality-control | reports/assets/competition_dry_run/submission_manifest.json | Manifest emitted by the competition submission packager for the dry-run submission. |
| quality-control | reports/assets/competition_dry_run/submission_lint.json | Machine-readable lint report proving the dry-run submission has no leakage, duplicate IDs, score errors, or ID coverage gaps. |
| reproducibility | reports/submission_artifact_hashes_2026_06_15.md | Reviewer-facing SHA-256 hash summary for checked-in submission packet artifacts. |
...
| result-data | reports/assets/reconstruction_lite_probe_delta_summary.csv | Delta summary for reconstruction_lite against combined_v3 on the bounded probe. |
| result-note | reports/reconstruction_lite_transfer_probe_2026_06_14.md | Bounded Ishu to MS COCOAI reconstruction_lite transfer diagnostic. |
...
| table | reports/assets/source_holdout_generator_stress.csv | Machine-readable source-stress figure data sorted by held-out generator utility. |
| figure | reports/assets/source_holdout_generator_stress.png | Held-out-generator stress chart highlighting the weakest source family. |
| figure | reports/assets/source_holdout_generator_stress.svg | Editable SVG source for the held-out-generator stress chart. |
...
| analysis | reports/paired_seed_statistical_support_2026_06_15.md | Paired-seed bootstrap support report for conservative model-comparison wording. |
| analysis | reports/assets/paired_seed_statistical_support.csv | Machine-readable paired-seed deltas, bootstrap intervals, and support labels. |
...
| table | reports/assets/latex_tables/paired_seed_support.tex | LaTeX fragment for paired-seed bootstrap deltas and conservative support labels. |
...
| planning | reports/manuscript_assembly_map_2026_06_14.md | Generated WIFS/DFF manuscript assembly map tying section drafts, page budgets, figures, and tables to writing tasks. |
