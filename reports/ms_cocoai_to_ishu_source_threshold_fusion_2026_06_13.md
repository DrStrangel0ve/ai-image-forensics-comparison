...
Follow-ups: `reports/ms_cocoai_to_ishu_threshold_tiebreak_probe_2026_06_13.md` keeps the same score model and source objective but uses conservative threshold tie-breaking, raising reverse operating-point accuracy to `0.7193`. `reports/ms_cocoai_to_ishu_threshold_cap_probe_2026_06_13.md` adds a source-side fake-rate cap and raises the current best reverse operating point to `0.7222`.
