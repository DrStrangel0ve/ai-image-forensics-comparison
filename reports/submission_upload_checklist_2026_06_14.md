...
| LaTeX tables and bibliography | ready_asset | reports/assets/latex_tables/same_domain_anchor.tex; reports/assets/latex_tables/transfer_frontier.tex; reports/assets/latex_tables/reverse_operating_points.tex; reports/assets/latex_tables/robustness_stress.tex; references.bib | Pull compact tables and references into the paper template; verify final citation metadata before submission. |  |
| figures | ready_asset | reports/assets/publication_score_fusion_clip_frontier.png; reports/assets/publication_triage_operating_points.png; reports/assets/publication_reverse_operating_points.png; reports/assets/publication_reverse_transform_robustness.png | Use a compact figure set; avoid overcrowding the 6-page paper. |  |
...
| failure-analysis material | ready_asset | reports/assets/qualitative_seed17_scp_fusion_false_negatives.png; reports/assets/qualitative_seed29_scp_fusion_false_negatives.png; reports/combined_v4_source_slice_diagnostics_2026_06_13.md | Use qualitative grids and source-slice diagnostics for the workshop failure-analysis section. |  |
